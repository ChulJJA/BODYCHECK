...
void PLAYER_UI::Initialize()
{
	...
	info_item->AddComponent(new Sprite(info_item, "../Sprite/throw.png", { this_trans.x + 200, this_trans.y}, false, Sprite_Type::Item_Throw), "throwing", false);
	...
	info_item->AddComponent(new Sprite(info_item, "../Sprite/Item.png", { this_trans.x + 200, this_trans.y}, false, Sprite_Type::Item_Missile), "missile", false);
